            ...
            <ul>
              ...
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  ...
                  <li>订单详情弹窗：分Tab展示订单信息（订单号/状态/时间/渠道/销售员/备注）、演出座位（演出名称/场馆/演出厅/场次/数量及座位明细表格）、支付减免（支付信息含商品总价/优惠减免/实付金额/支付时间/交易单号/组合支付明细；减免明细表格始终显示5种减免类型行：票品折扣/优惠券/券包/会员折扣/积分抵扣，有数据显示具体名称和金额，无数据显示0）、出票日志（出票状态/渠道/取票码/出票明细折叠面板含取票码、操作日志时间轴）。底部操作按钮：已支付状态显示"确认核销"和"申请退款"；预约状态显示"取消订单"和预约到期时间</li>
