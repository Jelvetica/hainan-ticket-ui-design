                ...
                <ul>
                  ...
                  <li><strong>功能实现逻辑：</strong>
                    <ul>
                      ...
                      <li>演出标签：后台自定义颜色和文字标签（CSS变量驱动），支持10种预设色+自定义文字（≤6字）</li>
                      <li>票品折扣标签：3种折扣类型标签（早鸟8折/满减100/折扣9.5折），标签颜色与折扣类型对应，显示在演出卡片底部</li>
                    </ul>
                  </li>
                ...
                tables: [
                    {
                        ...
                        rows: [
                            ...
                            ['custom_tags', 'array', '否', '自定义标签数组，每项含text（文字≤6字）和color（CSS颜色值）'],
                            ['labels', 'array', '否', '底部标签数组，每项含text和cls（soon/member/discount）'],
                            ['discount_tags', 'array', '否', '票品折扣标签数组，每项含type（earlybird/reduce/percent）和label（如"早鸟8折""满减100""折扣9.5折"）'],
        ...
        sections: [
            {
                ...
                <ul>
                  ...
                  <li>票品折扣标签：每个场次卡片内显示折扣类型+面值标签（早鸟8折/满减100/折扣9.5折），3种类型使用不同颜色区分（早鸟-橙黄、满减-绿色、折扣-金色），已售罄场次不显示折扣标签</li>
  ...
  <li><strong>边界条件：</strong>场馆地址为空时不显示导航按钮</li>
                ...
                tables: [
                    ...
                    },
                    {
                        ...
                        rows: [
                            ...
                            ['discount_type', 'enum', '否', '票品折扣类型：earlybird-早鸟 / reduce-满减 / percent-折扣 / null-无折扣'],
                            ['discount_label', 'string', '否', '折扣标签文本，如"早鸟8折""满减100""折扣9.5折"'],
    ...
    'user-miniapp/seat-selection.html': {
        ...
        sections: [
            {
                title: '功能描述',
                content: `<p><strong>核心功能：</strong>可视化座位选择，支持多票档切换、缩放控制、票品折扣展示（早鸟/满减/折扣三种类型）、优惠券和套票观演券抵扣，选座后跳转确认订单页面。选择座位时自动匹配对应票档的可用观演券，支持多张观演券同时使用。</p>
                <p><strong>业务说明：</strong></p>
                <ul>
                    ...
                    <li><strong>功能实现逻辑：</strong>
                        <ul>
                            ...
                            <li>价格计算：最终金额 = 原价总额 - 票品折扣 - 优惠券抵扣 - 套票观演券抵扣（多张可叠加）</li>
                            <li>底栏：显示实付金额（橙色大字）+ 划线原价（灰色小字，有优惠时显示）+ "价格明细"触发入口 + 确认选座按钮</li>
                            <li>价格明细弹窗：从底栏上方展开的深色毛玻璃面板，展示单价×数量、票品折扣、会员折扣、套票抵扣、优惠券、实付金额汇总行</li>
            ...
            },
            {
                ...
                <p><strong>查看价格明细</strong></p>
                <ul>
                    <li><strong>触发：</strong>选座后点击底栏"价格明细"文字入口（含向上箭头图标）</li>
                    <li><strong>执行中：</strong>底栏上方展开深色毛玻璃面板，显示单价×数量、票品折扣、会员折扣、套票抵扣、优惠券、实付金额汇总行；箭头旋转180度朝下</li>
                    <li><strong>成功：</strong>再次点击入口或点击遮罩关闭面板，箭头恢复朝上</li>
                    <li><strong>边界条件：</strong>未选座位时不显示"价格明细"入口</li>
                </ul>
                <p><strong>确认选座</strong></p>
                <ul>
                    <li><strong>触发：</strong>点击底栏右侧"确认选座"渐变橙色按钮</li>
                ...
                tables: [
                    ...
                    },
                    {
                        ...
                        rows: [
                            ...
                            ['ticket_policy_type', 'enum', '否', '当前折扣类型：earlybird-早鸟票 / reduce-满减 / percent-折扣 / null-无折扣'],
                            ['ticket_discount_amount', 'number', '否', '票品折扣金额（元），根据折扣类型计算'],
    ...
    'user-miniapp/order-confirm.html': {
        ...
        sections: [
            {
                title: '功能描述',
                content: `<p><strong>核心功能：</strong>展示选座后的订单确认信息，包含演出详情、已选座位、费用明细、取票人信息和多种支付方式（微信支付/钱包/充值卡/积分），支持组合支付模式，各支付方式可独立勾选/取消，支付方式卡片顶部展示支付组合总览条实时显示各方式金额，剩余不足部分由微信支付补足。多重支付方式同时启用时底部按钮文字变为"组合支付"。</p>
                <p><strong>业务说明：</strong></p>
                <ul>
                    ...
                    <li><strong>功能实现逻辑：</strong>
                        <ul>
                            ...
                            <li>支付方式：支持4种支付方式组合使用
                                <ul>
                                    <li>微信支付：默认勾选，可手动取消/重新勾选，自动计算并补足其他方式抵扣后的剩余金额</li>
                                    <li>钱包支付：可输入使用金额，支持"全部使用"按钮，可用余额不足时显示实际可用金额</li>
                                    <li>充值卡支付：支持单选一张充值卡支付，显示每张卡的余额和卡号；选中其他卡自动切换；实际抵扣金额为min(卡余额, 应付-其他已抵扣)</li>
            ...
            },
            {
                ...
                <ul>
                    ...
                    <li><strong>边界条件：</strong>微信支付默认勾选可手动取消；已全额抵扣时未启用的支付方式变为禁用状态不可选</li>
                </ul>
                ...
                <ul>
                    ...
                    <li><strong>执行中：</strong>卡片切换选中/未选中状态，显示勾选标记；选中其他卡时自动取消之前选中的卡</li>
                    <li><strong>成功：</strong>显示充值卡抵扣金额，应付金额重新计算</li>
                    <li><strong>边界条件：</strong>一次只能选择一张充值卡，抵扣金额不超过应付金额</li>
                </ul>
  ...
  <li><strong>边界条件：</strong>无历史页面时返回首页 home.html</li>
    ...
    'user-miniapp/order-ticket.html': {
        ...
        sections: [
            {
                title: '功能描述',
                content: `<p><strong>核心功能：</strong>为用户提供演出订单管理和电子票查看的统一入口。支持按订单状态筛选浏览，查看订单详情并执行对应操作（支付、取消、查看电子票等）。电子票夹仅展示订单级核销码QR，支持离线查看；新增电子门票下载功能，可批量下载多张门票图片。我的订单列表不展示二维码，通过"查看电子票"按钮引导跳转到电子票夹，方便用户在剧场现场快速核销入场。</p>
                <p><strong>业务说明：</strong></p>
                <ul>
                  <li><strong>前置条件：</strong>用户已登录</li>
                  <li><strong>功能实现逻辑：</strong>
                    <ul>
                      <li>进入页面时默认展示"我的订单"视图，加载全部状态订单列表，订单列表不展示二维码</li>
                      <li>订单按状态分组（待付款/待核销/已完成/已退款），支持Tab切换筛选</li>
                      <li>电子票夹仅展示订单级核销码QR（200px），扫码后展示订单内所有门票列表，不再展示每张门票的门票级QR</li>
                      <li>电子票QR为订单级核销码（O前缀15位），支持亮度调节以适应不同光照环境</li>
                      <li>下载功能：下载弹窗展示多张门票缩略图预览，每张票一个独立图片（400px QR码），提示用户"下载的是多张门票图片"</li>
                  ...
                  <li><strong>能力边界：</strong>已过期演出票不可核销；退款订单不可查看电子票；电子票不支持转赠；仅待核销/已完成状态可下载电子门票，已退款不可下载</li>
                </ul>`
            },
            {
                title: '交互说明',
                ...
                <ul>
                  <li><strong>触发：</strong>点击待核销/已完成订单的"查看电子票"按钮</li>
                  <li><strong>执行中：</strong>切换到电子票夹视图，展示订单级核销码QR（200px）、演出信息</li>
                  <li><strong>成功：</strong>订单级核销码QR正常渲染，支持亮度调节和截图保存</li>
                  <li><strong>边界条件：</strong>离线状态下展示本地缓存的电子票；已退款订单不展示"查看电子票"按钮</li>
                </ul>
                <p><strong>下载电子门票</strong></p>
                <ul>
                  <li><strong>触发：</strong>点击电子票夹中"下载电子门票(N张)"按钮</li>
                  <li><strong>执行中：</strong>弹出下载弹窗，展示N张门票缩略图预览，每张含座位号+QR缩略图，底部提示"下载的是多张门票图片，每张票一个图片文件"</li>
                  <li><strong>成功：</strong>确认下载后逐张生成图片（400px QR码）并保存到相册</li>
                  <li><strong>边界条件：</strong>仅待核销/已完成状态可下载，已退款不可下载</li>
                </ul>
                ...
                tables: [
                    {
                        ...
                        rows: [
                            ...
                            ['order_verify_code', 'string', '否', '订单级核销码，O前缀15位，格式O+YYMMDD+渠道ID(2位)+流水号(6位)']
                        ]
                    },
                    {
                        title: '电子票字段',
                        ...
                        rows: [
                            ...
                            ['order_verify_code', 'string', '是', '订单级核销码QR内容，扫码后展示订单内所有门票列表'],
                            ['show_title', 'string', '是', '演出名称'],
                            ['session_time', 'string', '是', '场次时间'],
                            ['ticket_count', 'number', '是', '订单内门票数量'],
                            ['downloadable', 'boolean', '是', '是否可下载电子门票'],
                    ...
                    },
                    {
                        ...
                        headers: ['字段名', '类型', '必填', '说明'],
                        rows: [
                            ['ticket_verify_code', 'string', '是', '门票级核销码，T前缀18位'],
                            ['seat_no', 'string', '是', '座位号'],
                            ['tier_name', 'string', '是', '票档'],
                            ['qr_image_url', 'string', '是', '门票级QR二维码图片URL，400px']
                        ]
                    }
                ]
            }
    ...
    'user-miniapp/order-detail.html': {
        ...
        sections: [
            {
                title: '功能描述',
                content: `<p><strong>核心功能：</strong>展示单个票务订单的完整详情，根据订单状态动态显示不同的信息区域和操作按钮。支持待支付倒计时、座位信息查看（含观演券抵扣标签和价格划线）、费用明细展示（含支付明细折叠区和积分抵扣行）、订单信息复制等功能。</p>
                <p><strong>业务说明：</strong></p>
                <ul>
    ...
    'user-miniapp/password-settings.html': {
        title: '支付安全',
        subtitle: '支付密码管理 + 实体卡管理 + 安全提示',
        sections: [
            {
                title: '功能描述',
                content: `<p><strong>核心功能：</strong>管理用户的支付密码设置与实体会员卡开关。用户可设置或修改6位数字支付密码，用于订单支付时的二次验证。支持实体会员卡功能的开启/关闭切换。安全提示区域展示支付安全相关注意事项，包括组合支付场景下的密码验证说明。</p>
                <p><strong>业务说明：</strong></p>
                <ul>
                  <li><strong>前置条件：</strong>用户已登录</li>
                  <li><strong>功能实现逻辑：</strong>
                    <ul>
                      <li>支付密码状态卡片：展示当前密码状态（已开启/未设置），提供修改/设置按钮</li>
                      <li>密码修改弹窗：底部弹出式弹窗，包含新密码和确认密码两个6位密码输入区域，输入完成后点击保存</li>
                      <li>实体卡管理：开关切换实体会员卡功能，开启后支持线下刷卡入场和享受会员权益</li>
                      <li>安全提示：展示支付密码用途说明、组合支付安全规则、密码保密提醒</li>
                    </ul>
                  </li>
                  <li><strong>数据约束：</strong>密码必须为6位数字；两次输入必须一致</li>
                  <li><strong>能力边界：</strong>不支持找回密码（需联系客服重置）</li>
                </ul>`
            },
            {
                title: '交互说明',
                content: `<p><strong>修改/设置支付密码</strong></p>
                <ul>
                  <li><strong>触发：</strong>点击状态卡片右侧"修改密码"或"立即设置"按钮</li>
                  <li><strong>执行中：</strong>底部弹出密码输入弹窗，包含新密码和确认密码两个6位输入区域，通过键盘输入数字</li>
                  <li><strong>成功：</strong>校验通过后保存密码，状态卡片更新为"支付密码已开启"，toast提示"支付密码修改/设置成功"</li>
                  <li><strong>失败：</strong>两次密码不一致时提示"两次输入的密码不一致，请重新输入"；密码不足6位时提示"请输入6位新密码"</li>
                </ul>
                <p><strong>切换实体会员卡</strong></p>
                <ul>
                  <li><strong>触发：</strong>点击实体会员卡开关</li>
                  <li><strong>成功：</strong>开关状态切换，toast提示"实体会员卡已开启/已关闭"</li>
                </ul>`
            },
            {
                title: '核心字段',
                ...
                tables: [
                    {
                        ...
                        headers: ['字段名', '类型', '必填', '说明'],
                        rows: [
                            ['is_password_set', 'boolean', '是', '是否已设置支付密码'],
                            ['payment_password', 'string', '否', '6位数字支付密码（加密存储）'],
                            ['is_physical_card_enabled', 'boolean', '是', '是否开启实体会员卡']
                        ]
                    }
                ]
            }
...
<ul>
  ...
  'admin-miniapp/admin-home-verify.html': {
    ...
    sections: [
      {
        title: '功能描述',
        content: `<p><strong>核心功能：</strong>管理员小程序主页面，采用混合主题设计（首页浅色+扫码深色），通过底部Tab切换，包含首页数据概览和扫码验票两大核心功能。首页提供运营数据统计与今日场次信息，扫码验票支持O/T前缀核销码自动分流核销。</p>
<p><strong>业务说明：</strong></p>
<ul>
  <li><strong>前置条件：</strong>管理员已登录</li>
  <li><strong>功能实现逻辑：</strong>
    <ul>
      <li>首页：顶部管理员信息头部（头像/姓名/角色/所属场馆），下方三张数据统计卡片（门票销售/已核销/待核销），今日场次列表（展示演出名称、场次时间、场馆），底部快捷操作入口</li>
      <li>扫码验票：点击扫码Tab进入深色主题扫码页，扫描到核销码后按前缀自动分流——O前缀（订单级）打开订单级核销弹窗，展示订单内所有门票列表，可勾选部分或全部核销；T前缀（门票级）打开门票级核销弹窗，展示单张门票详情直接核销</li>
      <li>手动输入：支持手动输入核销码（O或T开头），系统自动识别前缀并打开对应核销弹窗</li>
    </ul>
  </li>
  <li><strong>权限控制：</strong>需"验票"权限</li>
  <li><strong>数据约束：</strong>核销码格式为O+15位数字（订单级）或T+18位数字（门票级）</li>
</ul>`
      },
      {
        title: '交互说明',
        content: `<p><strong>扫码验票</strong></p>
<ul>
  <li><strong>触发：</strong>点击底部"验票"Tab进入扫码页</li>
  <li><strong>执行中：</strong>深色主题扫码页面，260x260取景框，扫描线上下往复动画，提示"将二维码放入框内，自动扫描"</li>
  <li><strong>成功：</strong>根据核销码前缀分流——O前缀打开订单级核销弹窗，T前缀打开门票级核销弹窗</li>
  <li><strong>失败：</strong>无效码提示"核销码格式错误"</li>
</ul>
<p><strong>订单级核销（O前缀）</strong></p>
<ul>
  <li><strong>执行中：</strong>弹出订单级核销弹窗，展示订单内所有门票列表（座位号/票档/核销状态），顶部显示订单级标识与核销码、订单号、观演人</li>
  <li><strong>操作：</strong>可勾选部分门票核销或全选全部核销，底部显示已选数量与"确认核销"按钮</li>
  <li><strong>成功：</strong>核销成功后Toast提示"已核销N张门票"，弹出结果弹窗显示核销座位数，可点击"继续验票"返回扫码</li>
</ul>
<p><strong>门票级核销（T前缀）</strong></p>
<ul>
  <li><strong>执行中：</strong>弹出门票级核销弹窗，展示单张门票详情（演出名称/场次/座位号/票档/票价/订单进度），顶部显示门票级标识与核销码，状态显示"待核销"</li>
  <li><strong>操作：</strong>点击"确认核销此票"完成核销</li>
  <li><strong>成功：</strong>Toast提示"核销成功"，状态更新为"核销成功"，按钮变为"已核销"并禁用</li>
</ul>
<p><strong>手动输入</strong></p>
<ul>
  <li><strong>触发：</strong>点击扫码页"手动输入票号"按钮</li>
  <li><strong>执行中：</strong>弹出输入弹窗，标题"手动输入核销码"，输入框提示"请输入核销码（O或T开头）"</li>
  <li><strong>成功：</strong>识别前缀并打开对应核销弹窗（O→订单级，T→门票级）</li>
  <li><strong>失败：</strong>无效格式提示"核销码格式错误"</li>
</ul>
<p><strong>闪光灯</strong></p>
<ul>
  <li><strong>触发：</strong>点击扫码页闪光灯按钮</li>
  <li><strong>操作：</strong>切换手电筒开关，辅助暗光环境扫码</li>
</ul>`
      },
      {
        title: '核心字段',
        ...
        tables: [
          ...
          },
          {
            ...
            rows: [
              ['session_id', 'number', '是', '场次唯一标识'],
              ['show_name', 'string', '是', '演出名称'],
              ['session_time', 'string', '是', '场次时间（格式 YYYY-MM-DD HH:mm）'],
          ...
          },
          {
            ...
            rows: [
              ...
              ['verify_code', 'string', '是', '核销码：O前缀15位为订单级，T前缀18位为门票级'],
              ['code_type', 'enum', '是', '核销码类型：order_level-订单级/ticket_level-门票级'],
              ...
              ['today_verified_count', 'number', '是', '今日已核销数量']
            ]
          }
        ]
      }
            ...
            <ul>
              ...
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  ...
                  <li>筛选查询：支持订单状态（全部/预约/待支付/已支付/部分退款/已退款/已完成/已取消）、关键词模糊搜索（订单号/演出名称/手机号）、渠道订单号精确查询、下单日期范围、支付方式（微信支付/支付宝/钱包支付/现金）、销售渠道（小程序/大麦/猫眼/美团/线下窗口）、销售员筛选</li>
                  <li>订单列表：展示订单号、渠道订单号、演出信息（名称+场次+票档）、数量、应收/实收金额、支付方式（带图标）、订单状态（彩色标签）、销售渠道（带图标标签）、销售员、下单时间、操作按钮</li>
                  <li>订单详情弹窗：分Tab展示订单信息（Tab0：订单号/状态/时间/渠道/销售员/备注，含"观演人信息"块展示观演人姓名+手机号，一个订单仅记录一个观演人）、演出座位（Tab1：演出名称/场馆/演出厅/场次/数量及座位明细表格，座位明细表格含"核销码"列展示门票级核销码）、支付减免（Tab2：支付信息含商品总价/优惠减免/实付金额/支付时间/交易单号/组合支付明细；减免明细表格始终显示5种减免类型行：票品折扣/优惠券/券包/会员折扣/积分抵扣，有数据显示具体名称和金额，无数据显示0）、出票日志（Tab3：出票信息仅展示取票码（含用途说明标签"扫码/手动输入取票，管理员选择性核销"），门票级核销码表格展示每张票的核销码和状态，出票明细折叠面板含操作日志时间轴）。底部操作按钮：已支付状态显示"确认核销"和"申请退款"；预约状态显示"取消订单"和预约到期时间</li>
                  <li>订单收款（3步流程）：Step1选择支付方式（微信支付/支付宝/现金/充值卡/钱包支付）→ 打开对应二级弹窗完成收款 → Step2选择出票方式（纸质票/电子票/暂不出票）及打印模板，电子票需填写接收手机号 → Step3完成，订单状态更新为"已支付"</li>
                  <li>出票：选择出票方式（纸质票/电子票），确认后门票状态更新为"已出票"，记录出票明细（含取票码）</li>
                  <li>核销码体系：采用双码结构。取票码（pickup_code，8位随机数字，一个订单一个，扫码和手动输入同一值）用于自助机取票和管理员选择性核销；门票级核销码（ticket_verify_code，T+YYMMDD+订单流水(4)+订单内序号(3)+双Luhn校验(2)=16位）每张票一个，用于单张门票核销</li>
                  <li>退票申请：选择退款手续费比例（0%/5%/10%），选择退票原因（观众原因/演出取消/演出延期/场次合并/其他，可多选），填写退票说明，系统根据手续费比例计算实际退款金额。退款弹窗显示每张票的核销码。提示：退款仅返还实付金额、钱包余额、充值卡金额，不返还任何优惠券、券包或积分</li>
                  <li>批量导入：下载Excel模板 → 填写渠道订单数据 → 上传文件 → 选择导入渠道 → 开始导入，支持大麦/猫眼/美团/票大师/票务通/线下窗口/其他渠道</li>
                  <li>订单状态流转：预约（窗口锁座）→ 收款 → 已支付 → 核销/退款 → 已完成；待支付（小程序下单）→ 支付 → 已支付；预约/待支付 → 已取消；已支付 → 管理员退部分票 → 部分退款 → 已完成/已退款；已支付 → 管理员退全部 → 已退款。"已完成"和"部分退款"为计算态，由门票状态实时推导</li>
                  <li>门票状态流转：待出票 → 已出票 → 已核销/已退款/已过期。演出结束24h后未核销的门票自动置为"已过期"，不可核销但管理员可手动退款</li>
                </ul>
              </li>
              <li><strong>权限控制：</strong>查看需"订单查看"权限；收款需"收银"权限；出票需"出票"权限；退款审核需"退款审核"权限；批量导入需"渠道订单导入"权限</li>
              <li><strong>数据约束：</strong>订单编号唯一；已退款/已完成订单不可再次退款；已取消订单不可收款；组合支付需记录各支付方式明细</li>
              <li><strong>能力边界：</strong>不支持修改订单信息；不支持手动创建订单；退款仅由管理员发起（用户端无退款入口）</li>
            </ul>`
          },
          {
            title: '交互说明',
            ...
            <ul>
              ...
              <li><strong>执行中：</strong>弹出订单详情弹窗（720px），分4个Tab展示完整订单数据：Tab0订单信息含"观演人信息"块（展示观演人姓名+脱敏手机号，一个订单仅记录一个观演人）；Tab1演出座位明细表格含"核销码"列展示门票级核销码（T前缀16位）；Tab2支付减免；Tab3出票信息仅展示取票码（含用途说明标签），门票级核销码表格展示每张票的核销码和状态，出票明细折叠面板含操作日志时间轴</li>
              <li><strong>成功：</strong>弹窗正常展示完整订单数据，底部根据状态显示不同操作按钮（已支付显示"确认核销"/"申请退款"；预约状态显示"取消订单"和预约到期时间）</li>
              <li><strong>失败：</strong>Toast提示"加载失败"</li>
              <li><strong>边界条件：</strong>弹窗内信息为只读，不可编辑；出票明细可点击展开/折叠</li>
            </ul>
            <p><strong>取消预约订单</strong></p>
            <ul>
              <li><strong>触发：</strong>点击预约状态订单详情弹窗底部的"取消订单"按钮（红色fa-times-circle + 取消订单）</li>
              <li><strong>执行中：</strong>弹出取消订单确认弹窗（480px），展示订单摘要（订单号/演出名称/场次时间/预约到期时间）和红色警告说明"取消订单后，预约的座位将释放，订单状态将变更为'已取消'，此操作不可恢复"</li>
              <li><strong>成功：</strong>订单状态变更为"已取消"，座位状态同步更新为"已取消"，列表自动刷新，Toast提示"订单已取消"</li>
              <li><strong>失败：</strong>Toast提示"操作失败"</li>
              <li><strong>边界条件：</strong>仅预约状态订单显示取消订单按钮；已支付/已核销/退款中/已取消订单不显示</li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>成功：</strong>确认出票后门票状态更新为"已出票"，记录出票明细（时间/操作员/地点），Toast提示"出票成功"</li>
            ...
            <ul>
              ...
              <li><strong>执行中：</strong>弹出退票申请弹窗（560px），显示订单摘要、每张票的核销码、退款手续费比例选择（0%/5%/10%，选择后实时更新手续费和实际退款金额）、退票原因多选、退票说明文本框，底部提示"退款仅返还实付金额、钱包余额、充值卡金额，不返还任何优惠券、券包或积分"</li>
              <li><strong>成功：</strong>确认退票后被退门票状态变为"已退款"，订单状态根据退款范围自动推导（部分退款/已退款/已完成），Toast提示"退票成功"</li>
            ...
            tables: [
              ...
              },
              {
                ...
                rows: [
                  ...
                  ['attendee_name', 'string', '否', '观演人姓名，一个订单仅记录一个观演人'],
                  ['attendee_phone', 'string', '否', '观演人手机号（脱敏展示）'],
                  ...
                  ['order_verify_code', 'string', '否', '订单级核销码，共15位，格式O+YYMMDD+渠道ID(2位)+流水号(6位)'],
              ...
              },
              {
                ...
                rows: [
                  ...
                  ['ticket_verify_code', 'string', '是', '门票级核销码，共18位，格式T+YYMMDD+渠道ID(2位)+订单标识(6位)+订单内序号(3位)']
                ]
              },
              {
                title: '批量导入字段',
              ...
              },
              {
                ...
                rows: [
                  ...
                  ['order_verify_code', 'string', '是', '订单级核销码，共15位，格式O+YYMMDD+渠道ID(2位)+流水号(6位)，订单支付成功后生成，用于订单维度核销'],
                  ['ticket_verify_code', 'string', '是', '门票级核销码，共18位，格式T+YYMMDD+渠道ID(2位)+订单标识(6位)+订单内序号(3位)，每张票一个，用于门票维度核销']
                ]
              },
              {
                title: '出票明细字段',
    ...
    sections: [
        ...
        sections: [
          {
            ...
            <ul>
              ...
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  <li>创建演出（3步向导）：Step1 基础信息（名称/类型/场馆/演出厅/封面/简介/时长/入场时间/儿童规则/语言/主办方/禁止携带/须知/日期范围）→ Step2 票价与场次（根据场馆座位分区自动生成票档，可设置票价；手动添加多个场次日期和时间）→ Step3 票务策略（设置统一开票时间；可选开启会员优先购：开票前N天会员可提前购买）→ 保存</li>
              ...
              <li><strong>会员优先购规则：</strong>开票前N天会员可提前购买（如开票前3天），仅指定会员等级可享受</li>
          ...
          },
          {
            ...
            <ul>
              ...
              <li><strong>执行中：</strong>弹出3步向导弹窗（modalNewShow），顶部步骤指示器显示当前进度，底部按钮：取消/下一步（Step1-2）/上一步+保存（Step3）；Step3包含：统一开票时间设置（datetime-local输入）、会员优先购开关（开启后显示提前天数/会员等级）</li>
      ...
      },
      {
        ...
        sections: [
          {
            title: '功能描述',
            content: `<p><strong>核心功能：</strong>管理所有演出的场次信息。支持按演出项目、场馆·厅、状态、日期范围筛选，支持批量选择。每个场次显示演出名称、场次时间、场馆·厅、已售数量、上座率（带进度条和颜色标识）、票房金额和状态。操作包括编辑、查看场次数据（弹窗含统计卡片+柱状图+票档明细表格）、停售/开售切换。新建场次通过弹窗创建，选择演出后自动展示演出信息。</p>
            <p><strong>业务说明：</strong></p>
            <ul>
              <li><strong>前置条件：</strong>演出项目需已创建；关联的演出厅需已配置座位</li>
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  <li>场次列表：支持筛选（演出/场馆·厅/状态/日期）+ 批量选择（checkbox）</li>
                  <li>统计卡片：总场次/未开票/售票中/已结束，4个指标</li>
                  ...
                  <li>编辑场次：弹窗回填数据，可修改日期/时间；状态不在编辑弹窗中修改，通过列表操作列的停售/开售按钮直接切换</li>
                  <li>停售/开售：列表操作列按钮直接切换场次状态（售票中↔已暂停），切换时同步更新状态标签</li>
                </ul>
              </li>
              <li><strong>权限控制：</strong>新建/编辑需"演出编辑"权限；停售/开售需"演出编辑"权限</li>
              <li><strong>数据约束：</strong>同一演出同一时间不可重复创建场次；已售出票的场次不可修改日期时间</li>
              <li><strong>能力边界：</strong>不支持批量删除；不支持场次复制；不支持删除场次</li>
            </ul>`
          },
          {
            title: '交互说明',
            ...
            <ul>
              ...
              <li><strong>执行中：</strong>弹出编辑弹窗，回填数据，可修改日期/时间；编辑弹窗不包含状态字段</li>
              <li><strong>成功：</strong>列表数据更新</li>
              <li><strong>失败：</strong>Toast提示"更新失败"</li>
              <li><strong>边界条件：</strong>已售出票的场次日期和时间字段置灰</li>
            </ul>
            <p><strong>停售/开售切换</strong></p>
            <ul>
              <li><strong>触发：</strong>点击操作列"停售"按钮（红色fa-pause-circle + 停售，状态为售票中时显示）或"开售"按钮（绿色fa-play-circle + 开售，状态为已暂停时显示）</li>
              <li><strong>执行中：</strong>直接切换场次状态，状态标签同步更新（售票中↔已暂停），按钮样式和文字同步切换</li>
              <li><strong>成功：</strong>列表对应行状态标签更新，按钮切换为对应状态的操作按钮，Toast提示"已停售"/"已开售"</li>
              <li><strong>失败：</strong>Toast提示"操作失败"</li>
              <li><strong>边界条件：</strong>已结束/未开票/已售罄的场次不显示停售/开售按钮</li>
            </ul>
            <p><strong>查看场次数据</strong></p>
            <ul>
              <li><strong>触发：</strong>点击操作列"数据"按钮（fa-chart-bar + 数据）</li>
              <li><strong>执行中：</strong>弹出数据弹窗（modalSessionData），展示票房金额/售票数/上座率/总座位4个统计卡片 + 各票档销售柱状图 + 票档明细表格</li>
              <li><strong>成功：</strong>弹窗正常展示数据</li>
              <li><strong>失败：</strong>无</li>
              <li><strong>边界条件：</strong>无数据时显示空状态</li>
            </ul>`
          },
          {
            title: '核心字段',
            ...
            <ul>
              ...
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  ...
                  <li>过期规则：积分有效期支持3种选项（12个月/24个月/永久有效），过期结算方式固定为"按获取月份逐月过期"，不可修改。设置到期前提醒天数</li>
          ...
          },
          {
            ...
            tables: [
              ...
              },
              {
                ...
                headers: ['字段名', '类型', '必填', '说明'],
                rows: [
                  ['points_validity', 'enum', '是', '积分有效期：12个月/24个月/永久有效'],
        ...
        sections: [
            ...
            <ul>
              ...
              <li><strong>功能实现逻辑：</strong>
                <ul>
                  ...
                  <li>关联范围：必须选择指定演出（不可选"全部演出"），指定演出可选择全部场次或部分场次（多选）；已售罄或已被其他折扣占用的场次显示为灰色禁用状态，右侧标注禁用原因标签（如"已售罄""已被其他折扣占用"），全选时自动跳过禁用项</li>
              ...
              <li><strong>权限控制：</strong>查看需"折扣活动查看"权限；新增/编辑需"折扣活动编辑"权限；停止/复制/删除需"折扣活动管理"权限</li>
          ...
          },
          {
            ...
            <ul>
              ...
              <li><strong>执行中：</strong>弹出新建弹窗，填写活动名称、关联演出（下拉选择，必须选择具体演出，选演出后加载场次多选）、折扣类型（百分比折扣/满减优惠/早鸟票，切换显示不同字段）、折扣比例/满减门槛和减免金额/早鸟票持续天数、最大优惠金额、开始/结束时间（早鸟票类型不显示活动时间）、活动说明、售票渠道（复选框：小程序/窗口，默认全选）；场次多选中已售罄或已被其他折扣占用的场次显示为灰色禁用，右侧标注原因（如"已售罄""已被其他折扣占用"），全选时自动跳过禁用项</li>
            ...
            <p><strong>删除折扣活动</strong></p>
            <ul>
              <li><strong>触发：</strong>点击操作列"删除"按钮</li>
              <li><strong>执行中：</strong>弹出确认框，提示活动名称和不可恢复警告"删除后不可恢复，进行中的活动将立即失效"</li>
              <li><strong>成功：</strong>列表行渐隐后移除，Toast提示"折扣活动已删除"</li>
              <li><strong>失败：</strong>Toast提示"删除失败"</li>
              <li><strong>边界条件：</strong>进行中的活动删除后立即失效；已结束活动可直接删除</li>
            </ul>
        ...
        entries: [
            {
                ...
                module: '首页装修',
                time: '18:00',
                content: '组件面板联动：已添加组件在面板中显示为不可用状态（opacity:0.4+pointer-events:none+draggable:false）；移除撤销/重做按钮；新增历史版本功能（每次保存自动创建版本，最多保留20个，支持归档/恢复/取消归档）；热门推荐移除"显示价格"字段，自定义推荐时隐藏"展示数量"；周边商品移除"显示价格"字段；预填充5个版本数据（含已归档版本）；归档版本仅在归档弹窗中显示；归档弹窗移除"恢复到此版本"按钮'
            },
            {
                ...
                module: '支付流程',
                time: '17:00',
                content: '钱包支付密码安全拦截：选择钱包支付后若未设置支付密码，弹出"设置支付密码"弹窗（含数字键盘、6位密码圆点实时反馈），设置成功后自动继续钱包密码验证流程，无需跳转离开确认订单页'
            },
            {
                ...
                module: '支付安全',
                time: '16:30',
                content: '余额卡片下方新增安全提示banner：橙色背景提示"未设置支付密码，请尽快设置保障资金安全"，右侧"去设置"链接跳转password-settings.html'
            },
            {
                ...
                module: '窗口售票',
                time: '15:00',
                content: '确认售票弹窗步骤2移除"上一步"按钮，仅保留"完成售票"；窗口售票6项修改：已选座位卡片固定205px高度、移除座位区域票档名称标签、场次折扣标签显示具体优惠信息（折扣/早鸟/满减+类型前缀）、订单摘要合并票品折扣和早鸟为一行、移除右下角场次优惠提示条、支付方式"会员卡"改为"钱包"；渠道售票：已选座位卡片固定350px、渠道管理增加编辑按钮、新增/编辑渠道弹窗增加渠道编码字段、渠道改为启用/停用双态管理+显示停用渠道开关、移除删除按钮'
            },
            {
                page: 'pc-admin/marketing-center.html',
                pageName: '营销中心',
                module: '邀请有礼/充值成长值',
                time: '12:00',
                content: '邀请有礼重新设计：改为手动配置（填写手机号或选择会员），移除自动邀请；卡片文字重新设计（邀请者奖励、被邀请者充值赠送）；银卡门槛提示（3,000成长值）；开关控制邀请有礼开启状态；卡片布局微调（移除"邀请充值专属"标签、开关+状态文字右对齐不换行、被邀请者充值和赠送合并为一行、移除底部灰色说明文字）；充值成长值活动卡片移除灰色背景框、开关右对齐不换行、内容防溢出；表单布局优化（活动名称+比例并排、时间独占一行、提示文字底部一行）；移除"赠送翻倍"提示'
            },
            {
                page: 'pc-admin/project-management.html',
                pageName: '演出项目管理',
                module: '项目状态',
                time: '11:00',
                content: '整理演出项目状态模型：5种状态（草稿/待发布/售票中/已下架/已结束）+正确流转路径；待发布状态补齐场次和标签按钮'
            },
            {
                ...
                module: '首页展示',
                time: '10:00',
                content: '演出剧院区块卡片文字调整："近期排期 **场"统一改为"当前演出 **"（移除"场"字）'
            },
            {
                ...
                module: '剧院信息',
                time: '09:30',
                content: '移除"营业时间"字段；当前演出卡片时间显示改为日期范围格式（如"2025.01.15 - 01.16"），价格显示改为最低票档（如"¥280起"），移除原价划线'
            }
        ]
    },
    {
        ...
        entries: [
            ...
            },
            {
                ...
                module: '组合支付流程',
                time: '14:00',
                content: '组合支付待支付订单控制流程：待支付时长15分钟，15分钟内可主动取消；外部渠道不设同步超时，内部取消时主动调用关单接口关闭外部支付订单；新增预扣vs冻结对比表；场景A-D共4个'
            },
            {
            ...
            },
            {
                ...
                module: '邀请弹窗',
                time: '10:00',
                content: '拆分邀请弹窗中混淆的奖励与权益：原"开通银卡即享 · 你获1000成长值"合并标题拆为两个独立区域——上方"你的奖励"卡片（金色硬币图标+邀请成功你的奖励+1000成长值），下方"好友开通银卡即享"权益卡片（5个权益标签），消除"1000成长值是银卡权益"的误解'
            },
            {
                ...
                module: '演出项目状态',
                time: '20:00',
                content: '演出项目tab状态模型整理：1.定义5个状态（待发布→未开票→售票中→已下架→已结束），off-shelf CSS从灰色改为金色与ended区分；2.过滤按钮新增"已下架"，移除"上下架状态"下拉筛选；3.Row 4《不老的东坡》从"待发布"改为"未开票"（已发布，开票时间7-10在未来）；4.Row 5.5《寻光》从"已结束(off-shelf类)"改为"已下架"（演出进行中但暂停售票），添加上架按钮；5.confirmPublishShow()重写：开票时间在未来→未开票，立即开票→售票中，售票中自动添加下架按钮；6.confirmForceOffShelf()修正：状态设为"已下架"而非"已结束"；7.统计卡片待发布从2改为1，新增已下架统计(1)'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员政策-邀请有礼',
                time: '21:00',
                content: '邀请有礼配置重构为手动配置模式：1.配置项改为三组独立数值（邀请奖励1000成长值/被邀请者充值800元/赠送200成长值），系统不做运算；2.新增银卡门槛提示条（金色，显示"当前L2银卡会员成长值门槛1,000"），管理员自行判断配置合理性；3.新增开关（benefit-toggle），关闭后配置区域灰化禁用，状态文字切换"已开启/已关闭"；4.删除updateInvitePreview()百分比运算函数，替换为toggleInviteReward()开关函数；5.配置提示区说明"充值成长值+赠送成长值≥银卡门槛"'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员政策-邀请有礼',
                time: '22:00',
                content: '邀请有礼卡片文字重新设计：1.银卡门槛+充值比例+活动比例整合为3个并排迷你卡片（金色/蓝色/橙色），一眼可见关键参考数据；2.移除配置项逐条括号说明和冗长的配置提示块；3.底部两行简洁提示说明当前配置效果和活动期间变化；4.充值成长值活动开关从body内toggle-switch改为header内benefit-toggle（与邀请有礼一致），关闭后灰化禁用+状态文字"已开启/已关闭"，toggleGrowthActivity()函数重写为灰化逻辑'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员政策-邀请有礼',
                time: '23:00',
                content: '邀请有礼卡片布局微调：1.移除"邀请充值专属"标签；2.开关+状态文字用white-space:nowrap包裹右对齐，不换行；3."邀请奖励"改为"邀请者奖励"；4.被邀请者充值和赠送合并为一行（gap:12px）；5.移除底部灰色说明文字。充值成长值活动表单布局优化：活动名称+活动比例并排同一行（flex），活动时间独占一行（两端datetime-local自适应宽度），提示文字独占底部一行'
            },
            {
                page: 'pc-admin/ticket-sales.html',
                pageName: '售票管理',
                module: '窗口售票',
                time: '09:00',
                content: '窗口售票tab页面6项修改：1.已选座位卡片固定高度205px（st-selected-seats-card类），座位多少不改变高度；2.座位区域移除票档名称标签（VIP区/A区等）；3.左侧场次折扣标签显示具体优惠信息：折扣→8.5折最高优惠15%、早鸟→8折2026-04-15前、满减→满300-50（新增fullcut绿色标签）；4.订单摘要合并票品折扣+早鸟为一行"票品折扣（8.5折+早鸟8折）"，会员折扣标签从"会员9.5折"改为"会员折扣"；5.移除右下角"当前场次优惠"提示条（stBottomSessionInfo）；6.支付方式"会员卡"改为"钱包"，支付弹窗标题"会员卡支付"改为"钱包支付"'
            }
        ]
    },
    {
        ...
        entries: [
            {
                ...
                module: '门票规则',
                time: '10:00',
                content: '门票规则章节重构：在"码的关联关系"前新增"二、订单与门票状态机制"章节，含订单状态（7种：预约/待支付/已支付/部分退款/已退款/已完成/已取消）、门票状态（5种：待出票/已出票/已核销/已过期/已退款）、订单状态推导规则、订单状态流转图、门票状态流转图、出票方式（电子票/纸质票/暂不出票/组合出票）；原"二、码的关联关系"顺延为三，"三、使用场景"顺延为四；删除原"四、状态枚举"章节（内容已合并到新章节）'
            },
            {
                page: 'user-miniapp/member-center.html',
                pageName: '会员中心',
                module: '邀请有礼',
                time: '15:30',
                content: '邀请好友充值弹窗机制重构：原"充值800元立省200元开银卡"（门槛打折，存在自邀漏洞）改为"成长值加速"机制——被邀请者充值达银卡门槛80%（¥800）得800成长值，系统额外赠送20%成长值（200），合计1000成长值直达银卡门槛，门槛不变堵住漏洞；弹窗标题改为"邀好友充值 加速开银卡"，奖励卡片从"¥800好友专享价"改为"+200额外成长值"，规则步骤更新为成长值加速达标逻辑；海报价格对比从"原价¥1000→¥800立省200"改为"银卡需1000成长值→充值¥800+赠200成长值"，二维码说明同步更新；充值金额与赠送成长值根据后台会员政策（等级门槛+充值比例）动态推导'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员政策',
                time: '15:30',
                content: '成长值配置区新增"邀请有礼"配置卡片：邀请者奖励成长值为可配置项（默认1000成长值/人）；被邀请者权益为系统固定规则（不可配置）——充值达银卡门槛80%额外赠送20%成长值，并展示当前配置下的推导结果（充¥800+赠200=1000直达银卡）；新增gc-icon--rose图标样式'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员政策',
                time: '16:30',
                content: '邀请有礼卡片优化：被邀请者权益从"系统固定20%"改为可配置"赠送成长值"绝对值（默认200），解决百分比不直观问题；新增实时预览框，管理员调整赠送成长值时实时展示推导链路（充值金额=（门槛−赠送）÷比例）；新增每人限邀次数（默认3人）和活动预算上限（默认10万成长值）两个控制项；赠送成长值上限约束为银卡门槛50%，超出时红色预警提示；updateInvitePreview()函数实现联动计算'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
        ...
        entries: [
            {
                ...
                module: '流程图弹窗',
                time: '16:00',
                content: '流程图弹窗"出票与核销流程设计"整体重写为"门票规则"：删除旧的订单级核销码(O码)体系，改为双码体系——8位随机取票码(pickup_code，扫码和手动输入同一值)+门票级核销码(ticket_verify_code，T+18位含订单流水+Luhn校验位)；新增7个使用场景（线上购票/自助机扫码取票/自助机手动输入/管理员选择性核销/管理员单张核销/窗口暂不出票/闸机入场）；核销码可从码直接还原订单号无需查库'
            },
            {
                page: '出票核销流程设计.md',
                pageName: '设计文档',
                module: '设计文档',
                time: '16:00',
                content: '文档完整重写：标题改为"门票规则与核销设计"；删除O码相关内容；取票码QR内容=取票码本身（8位数字），不再包含URL路由；核销码编码规则更新为T+YYMMDD+渠道ID(2)+订单流水(4)+订单内序号(3)+校验位(2)=18位；新增码关联关系图、7个使用场景流程图、状态流转图'
            },
            {
                ...
                module: '选座购票',
                time: '12:50',
                content: '票品折扣卡片重构为3种类型展示（早鸟/满减/折扣），非激活卡片提亮；底栏间距优化加大左右内边距；价格明细从页面内联改为底栏上方展开的深色毛玻璃弹窗，底栏新增"价格明细"触发入口和划线原价小字；早鸟票移除最高减¥200（仅折扣优惠有），折扣优惠移除限购（无限购）'
            },
            {
                ...
                module: '场次选择',
                time: '12:50',
                content: '移除独立的早鸟票优惠横幅，改为在每个场次卡片内显示票品折扣标签（折扣类型+面值，如"早鸟8折""满减100""折扣9.5折"），3种折扣类型使用不同颜色区分，已售罄场次不显示折扣标签'
            },
            {
                page: 'user-miniapp/show-list-detail.html',
                pageName: '演出列表',
                module: '演出列表',
                time: '12:50',
                content: '演出标签改为自定义颜色和文字（CSS变量驱动），新增3种票品折扣标签（早鸟/满减/折扣），标签样式与折扣类型颜色一致'
            },
            {
                page: '出票核销流程设计.md',
                pageName: '设计文档',
                module: '状态枚举',
                time: '14:33',
                content: '订单状态重构：删除"部分核销""已核销""退款中"，新增"预约"（窗口锁座）和"已完成"（全部门票已终结）；"部分退款"和"已完成"明确为计算态由门票状态推导；门票状态删除"未出票""待出票""已作废"，新增"已过期"（演出结束24h未核销自动触发）；新增订单状态推导规则；状态流转图重绘'
            },
            {
                page: 'pc-admin/order-management.html',
                pageName: '订单管理',
                module: '票务订单',
                time: '14:33',
                content: '订单详情弹窗Tab3出票信息精简：移除出票状态、出票渠道、出票方式三行，仅保留取票码（含用途说明标签）'
            },
            {
                page: 'pc-admin/order-management.html',
                pageName: '订单管理',
                module: '票务订单',
                time: '15:25',
                content: '订单状态和门票状态实例全面更新：状态筛选下拉更新为7种订单状态（预约/待支付/已支付/部分退款/已退款/已完成/已取消）和5种门票状态（待出票/已出票/已核销/已过期/已退款）；12个订单实例状态映射更新（已核销→已完成、退款中→已退款、已退票→已退款、未出票→待出票）；退款操作逻辑重构为根据退款范围自动推导订单状态（部分退款/已退款/已完成）；新增status-reserved和status-partial-refunded CSS类；统计卡片"退款中"改为"部分退款"'
            }
        ]
    },
    {
        ...
        entries: [
            {
                ...
                module: '票务订单',
                time: '17:30',
                content: '新增两级核销码体系：订单级核销码（O前缀15位）记录在订单上，门票级核销码（T前缀18位）记录在每个座位上；观演人信息从数组改为单字段（attendeeName/attendeePhone）；订单详情弹窗Tab0新增观演人信息块，Tab1座位明细新增核销码列，Tab3出票日志展示订单级+门票级两级核销码，退款弹窗显示每张票核销码；核销码渠道标识改为动态channel_id（2位），关联sales_channels表'
            },
            {
                page: 'pc-admin/order-management.html',
                pageName: '订单管理',
                module: '票务订单',
                time: '17:30',
                content: '核销码编码规则更新：订单级O+YYMMDD+渠道ID(2位)+流水号(6位)=15位，门票级T+YYMMDD+渠道ID(2位)+订单标识(6位)+订单内序号(3位)=18位，门票级码可直接还原订单级码无需查库'
            },
            {
                ...
                module: '核验首页',
                time: '17:30',
                content: '扫码验票支持O/T前缀自动分流：O前缀打开订单级核销弹窗（展示订单内所有门票列表可选择性核销），T前缀打开门票级核销弹窗（单张门票直接核销）；新增门票级核销弹窗#ticketVerifyModal；手动输入框提示改为"请输入核销码（O或T开头）"'
            },
            {
                ...
                module: '订单与电子票',
                time: '17:30',
                content: '电子票夹仅展示订单级核销码QR（120px），不再展示门票级QR；新增下载弹窗#downloadModal含多张门票缩略图预览，提示"下载的是多张门票图片"，每张票独立图片含200px QR码；我的订单列表移除二维码，新增"查看电子票"按钮跳转至电子票夹视图'
            },
            {
                page: 'index.html',
                pageName: '设计总览',
                module: '设计总览',
                time: '17:30',
                content: '流程图弹窗"出票与核销流程设计"markdown全面更新：1.1订单字段观演人改为单字段（attendeeName/attendeePhone/attendeeIdNo），渠道改为channel_id+channel_name动态引用；1.3新增sales_channels销售渠道表设计，编码规则渠道标识从1位硬编码改为2位动态channel_id，门票级码新增订单标识(6位)和3位订单内序号(18位总长度），新增订单级与门票级码关联ASCII图'
            },
            {
                page: 'user-miniapp/home.html',
                pageName: '小程序首页',
                module: '首页',
                time: '17:30',
                content: '超值套票更名为超值券包，全部套票更名为全部券包，演艺畅享套票更名为演艺畅享券包'
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '积分管理',
                time: '17:30',
                content: '积分明细订单号从#ORD20260409改为#HN202604100001'
            },
            {
                page: 'pc-admin/marketing-center.html',
                pageName: '营销中心',
        ...
        entries: [
            {
                ...
                pageName: '会员管理',
                module: '会员钱包',
                content: '会员钱包tab筛选条件移除"全部变动类型"下拉框；列表字段"累计消费"改名为"钱包累计消费"；钱包明细弹窗增加分页（共28条记录，第1/3页，页码按钮+上一页/下一页）；钱包明细弹窗增加"卡转入"类型记录；弹窗宽度从720px增至960px保证类型列显示完整'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        entries: [
            ...
            },
            {
                ...
                module: '确认订单',
                time: '16:30',
                content: `新增组合支付交互：支付方式卡片顶部增加支付组合总览条（彩色标签展示各支付方式及金额）；微信支付改为可手动勾选/取消（默认勾选）；多重支付方式时底部按钮文字变为"组合支付"；充值卡全额抵扣后不可继续选择新卡；已全额抵扣时未启用的支付方式变为禁用状态；未选微信支付且选了钱包支付时弹出钱包密码验证弹窗；底栏应付金额与费用明细一致不受支付方式影响；"已优惠"统计不含钱包和充值卡金额`
            },
            {
                page: 'user-miniapp/order-detail.html',
                pageName: '订单详情',
                module: '订单详情',
                time: '16:30',
                content: `费用明细区新增支付明细折叠区（默认折叠，点击展开显示微信/钱包/充值卡各支付方式及金额，带对应颜色图标）；积分抵扣从支付明细移至费用明细行（与优惠券抵扣样式相同）；座位信息增加观演券抵扣标签和价格划线样式；支付方式显示改为"组合支付"`
            },
            {
                ...
                module: '支付安全',
                time: '16:30',
                content: `安全提示新增组合支付说明：小程序上使用组合支付方式时，通过微信支付密码验证后将不再重复验证钱包密码`
            },
            {
                page: 'pc-admin/marketing-center.html',
                pageName: '营销中心',
                module: '充值卡',
                time: '17:00',
                content: `批次详情弹窗-最近使用记录改为表格列表形式，增加表头（卡号/用户/支付单号/时间/金额），数据使用RC前缀支付单号格式`
            },
            {
                page: 'user-miniapp/order-confirm.html',
                pageName: '确认订单',
                module: '确认订单',
                time: '17:00',
                content: `充值卡支付从多选改为单选：一次只能选择一张充值卡，选中其他卡自动切换，描述显示卡名和抵扣金额`
            },
            {
                page: 'user-miniapp/order-detail.html',
                pageName: '订单详情',
                module: '订单详情',
                time: '17:00',
                content: `待支付订单点击支付后弹出支付方式选择弹窗（与确认订单页交互逻辑一致）：支持微信支付/钱包支付（可输入金额+全部使用）/充值卡支付（单选）；弹窗视觉重构为卡片式设计（顶部渐变装饰条/应付金额卡片/独立白色选项卡片/彩色选中边框/sticky悬浮按钮/毛玻璃效果）；充值卡改为单选；展开区域与父卡片无缝衔接`
            },
            {
                page: 'pc-admin/order-management.html',
                pageName: '订单管理',
                module: '票务订单',
                time: '16:30',
                content: `mock数据更新：取票码改为14位纯数字格式（86+YYMMDD+4位序号+2位随机数），支付单号改为英文+数字格式（支付方式前缀+时间戳+2位随机字母）；出票明细移除取票码列`
            },
            {
                page: 'pc-admin/member-management.html',
                pageName: '会员管理',
                module: '会员钱包',
                time: '16:30',
                content: `钱包流水明细弹窗标题改为"钱包明细"，表头"流水号"改为"支付单号"，列表按钮文字同步更新`
            }
        ]
    },
    {
        ...
        entries: [
            {
                ...
                module: '票务订单',
                time: '16:00',
                content: `预约类型订单详情弹窗底部新增"取消订单"按钮（红色danger样式），点击打开确认弹窗，弹窗展示订单摘要、预约到期时间、取消后果警告说明，确认后订单状态变更为"已取消"；footer左侧同步展示预约到期时间（黄色时钟图标+时间文本）`
            },
            {
                page: 'pc-admin/show-management.html',
                pageName: '演出管理',
                module: '场次管理',
                time: '15:00',
                content: `数据卡片状态标签"已开票"改为"未开票"、"进行中"改为"售票中"；编辑弹窗去掉"状态"修改字段；列表操作列新增"停售/开售"切换按钮，点击直接切换场次状态（售票中↔已暂停）；列表样式改为table-layout:auto自适应宽度，移除所有固定列宽和min-width:900px限制，低分辨率下支持横向滚动，操作按钮允许换行显示`
            }
        ]
    },
    {
        ...
        entries: [
            {
                ...
                module: '演出项目',
                time: '01:00',
                content: `新建/编辑步骤2移除可用库存列和限购数量列，提示票价不可修改；新建/编辑步骤3开票时间卡片改为上架与开票，合并上下架开关；列表状态更新为未开票/售票/已下架/已结束四种，7行数据覆盖全部状态；上下架按钮每次操作弹确认提示，图标统一为toggle-on/toggle-off`
            },
            {
                page: 'user-miniapp/show-detail.html',
                pageName: '演出详情',
